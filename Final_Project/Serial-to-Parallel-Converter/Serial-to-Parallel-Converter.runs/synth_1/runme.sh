...
HD_PWD='C:/Users/Monica Pedro/Documents/ECE_524/Final_Project/Serial-to-Parallel-Converter/Serial-to-Parallel-Converter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S_to_P_Converter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S_to_P_Converter.tcl
