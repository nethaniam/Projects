...
HD_PWD='C:/Users/Public/Documents/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S_to_P_Converter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S_to_P_Converter.tcl -notrace
